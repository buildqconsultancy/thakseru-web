...
{/* Sleek Compact Header with Sharp Prominent Logo */}
      <header className="border-b border-slate-800/80 bg-slate-950/90 backdrop-blur-md sticky top-0 z-50 transition-all duration-300">
        <div className="max-w-6xl mx-auto px-4 h-20 sm:h-24 flex items-center justify-between">
          <div className="flex items-center">
            <img
              src="/logo.png"
              alt="තක්සේරු.lk"
              className="h-12 sm:h-16 md:h-18 w-auto object-contain drop-shadow-[0_0_20px_rgba(56,189,248,0.5)] hover:scale-105 transition-transform duration-200"
            />
          </div>
          <a
            href="#boq-packages"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-sky-500/20 hover:shadow-sky-500/35 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
          >
      ...
      <section className="relative overflow-hidden pt-14 pb-12 text-center px-4">
        {/* Subtle pulsating radial background */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(14,165,233,0.22),rgba(255,255,255,0))] animate-pulse duration-1000 pointer-events-none" />

        <div className="max-w-4xl mx-auto relative z-10">
          <span className="inline-flex items-center gap-2 bg-sky-950/80 border border-sky-800/60 text-sky-300 text-xs font-bold px-4 py-1.5 rounded-full mb-6 uppercase tracking-wider shadow-sm shadow-sky-500/10 hover:border-sky-500/50 transition-colors">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              href="#boq-packages"
              className="bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold px-8 py-3.5 rounded-xl shadow-xl shadow-sky-500/25 hover:shadow-sky-500/40 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
              Certified BOQ සේවාවන් බලන්න
            </a>
            <a
              href="#calculators"
              className="bg-slate-900/90 hover:bg-slate-800 text-slate-300 hover:text-white border border-slate-800 hover:border-slate-700 font-semibold px-6 py-3.5 rounded-xl hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
            >
              ද්‍රව්‍ය ගණනය කරන්න ↓
            </a>
          </div>
      ...
      <section id="boq-packages" className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Package 1 */}
          <div className="bg-slate-900/90 border border-sky-500/40 rounded-3xl p-7 shadow-xl hover:shadow-2xl hover:shadow-sky-500/10 hover:border-sky-400 hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group">
            <div>
            ...
            <a
              ...
              className="w-full text-center bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold py-3 rounded-xl shadow-md hover:shadow-sky-500/30 transition-all duration-200"
            >
          ...
          {/* Package 2 */}
          <div className="bg-slate-900/90 border border-slate-800 hover:border-slate-600 rounded-3xl p-7 shadow-xl hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group">
            <div>
              <div className="flex justify-between items-start mb-4">
      ...
      <section id="calculators" className="max-w-4xl mx-auto px-4 pt-10 pb-20">
        ...
        {/* Tab Controls */}
        <div className="grid grid-cols-3 gap-2 bg-slate-900/90 border border-slate-800 p-1.5 rounded-2xl max-w-lg mx-auto mb-8 shadow-inner">
          <button
            onClick={() => setActiveTab("tile")}
            className={`py-2.5 text-xs md:text-sm font-bold rounded-xl transition-all duration-200 ${
              activeTab === "tile"
        ...
        {activeTab === "tile" && (
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl transition-all duration-300">
            ...
            <div className="mb-6 bg-slate-950/60 p-4 rounded-2xl border border-slate-800/80">
              <div className="flex justify-between items-center mb-3 border-b border-slate-800 pb-2">
                ...
                <button
                  ...
                  className="bg-slate-800 hover:bg-sky-500 hover:text-slate-950 text-sky-400 text-xs font-bold px-3 py-1 rounded-lg hover:scale-105 active:scale-95 transition-all"
                >
                  + Add Room
                </button>
              </div>
              ...
              <div className="space-y-3">
                {rooms.map((r, idx) => (
                  <div key={r.id} className="flex flex-wrap items-center gap-2 bg-slate-900 p-3 rounded-xl border border-slate-800 text-sm hover:border-slate-700 transition-colors">
                    ...
                    <input
                      ...
                      className="w-24 bg-slate-950 border border-slate-800 rounded-lg px-2.5 py-1.5 text-xs text-white focus:outline-none focus:border-sky-500 transition-colors"
                    />
                    <input
                      type="number"
            ...
            {/* Results Grid with smooth hover & transitions */}
            <div className="bg-slate-950 border border-slate-800 rounded-2xl p-6 space-y-4 shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-center">
                <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl hover:border-sky-500/40 hover:-translate-y-1 transition-all duration-200">
                ...
                {includeSkirting ? (
                  <div className="bg-slate-900 border border-amber-500/30 p-4 rounded-xl hover:border-amber-400 hover:-translate-y-1 transition-all duration-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center pt-2">
                {includeSkirting && (
                  <div className="bg-slate-900/80 border border-slate-800 p-3.5 rounded-xl hover:border-slate-700 transition-colors">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl transition-all duration-300">
            ...
            <div className="mb-6 bg-slate-950/60 p-4 rounded-2xl border border-slate-800/80">
              ...
              <div className="space-y-2.5">
                {walls.map((w, idx) => (
                  <div key={w.id} className="flex flex-wrap items-center gap-2 bg-slate-900 p-2.5 rounded-xl border border-slate-800 text-sm hover:border-slate-700 transition-colors">
            ...
            <div className="bg-slate-950 border border-sky-500/30 rounded-2xl p-6 shadow-xl space-y-3 text-sm">
              ...
              <div className="flex justify-between items-center py-2 bg-slate-900/90 px-3.5 rounded-xl border border-slate-800 hover:border-slate-700 transition-colors">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-slate-950 to-slate-900 border border-sky-500/30 rounded-2xl p-6 shadow-xl relative overflow-hidden">
              ...
              <div className="grid grid-cols-3 gap-3 md:gap-4 text-center">
                <div className="bg-slate-900/90 border border-slate-800 p-4 rounded-xl hover:border-sky-500/40 hover:-translate-y-1 transition-all duration-200">
